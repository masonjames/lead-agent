...
import { normalizeParcelId, extractParcelIdFromManateePaoUrl } from "../../utils/parcel-id";
...
export function normalizeManateePaoPropertyDetails(
  ...
  if (!parcelIdRaw && meta.sourceUrl) {
    parcelIdRaw = extractParcelIdFromManateePaoUrl(meta.sourceUrl) || undefined;
  }
